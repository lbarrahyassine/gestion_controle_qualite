...
# Form implementation generated from reading ui file '.\create_ctrl.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_date_ech = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_date_ech.setGeometry(QtCore.QRect(170, 430, 141, 22))
        self.lineEdit_date_ech.setObjectName("lineEdit_date_ech")
    ...
    def load_data(self):
        ...
        for row in fetch_equipements_combo():
            libele=row[0]
